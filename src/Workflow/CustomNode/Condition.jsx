  ...
  return (<>
    ...
    >
      <div className="flex items-center justify-center h-[100%]">
        <div className="ml-2 transform rotate-45 p-4">
      ...
      <Handle type="target" position={Position.Top} className="!w-3 !h-3 !ml-[47%] !left-[57%] !top-[-8%] !bg-teal-500"  />
      <Handle type="source" position={Position.Bottom} className="!w-3 !h-3 !ml-[-49%] !bottom-[-8%] !left-[45%] !bg-teal-500" />
    </div>
