...
function CustomNode({ data }) {
  ...
  return (
    <div className="resize shadow-md rounded-full bg-white border-2 border-red-400"
      ref={fatherRef}
      style={{
        height
      }}
    >
      ...
      {/* <Handle type="target" position={Position.Top} className="!-z-10 !top-[-0px] !bg-teal-500" /> */}
